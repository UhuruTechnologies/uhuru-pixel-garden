...
export default function HomePage() {
  useEffect(() => {
    // Load the main.js module after the page is fully loaded
    // This ensures all DOM elements are available when the script runs
    ...
    if (document.readyState === 'complete') {
      ...
      return () => window.removeEventListener('load', loadMainScript);
    }
  }, []);
